...
* Библиотеки ESP весии 2.5.2 и FastLED 3.2.0 - проект не компилируется, ошибка переопределения типа  

typedef bool boolean;   

Для устранения ошибки компилляции - в файле библиотеки FastLED в папке "FastLED/platforms/esp/8266/led_sysdefs_esp8266.h" в строке 15 закомментируйте переопределение типа   
