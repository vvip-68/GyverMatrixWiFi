...
#### Изменения по справнению с исходным пректом:
 ...
 - Настройки режимов можно изменять из программы со смартфона
   ...
   - Включение/исключение режима из списка автовоспроизведения (план)
 - Настройки сохраняются в энергонезависимой памяти EEPROM
 - К режиму часов добавлен календарь (план)
 - Будильник "рассвет", настройки через программу на смартфоне (план) 
